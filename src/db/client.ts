...
async function migrateIfNeeded(db: any) {
  await db.execAsync(`
    ...
    CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY NOT NULL, company_id TEXT, role TEXT DEFAULT 'technician', display_name TEXT, phone TEXT, email TEXT, avatar_url TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, synced INTEGER DEFAULT 0);
